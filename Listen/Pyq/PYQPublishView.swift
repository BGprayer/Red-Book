            ...
            HStack{
                Button{
                    ...
                    if self.mytitle != "" && self.mycontent != "" && pickeimage != []{
                        mySaveobject.Saveobjects = saveobject(mysavedimage:mySaveobject.convert(image:pickeimage), mypyqmessage: Carddata(title: mytitle, content: mycontent, locate:locate, publishtime:Date(),publishimageurl: [], pinlun: [],love:0,star:0,pyqobjectid : "",client : Client(username: "", clientname: "", introduction: "", sex: "", locate: "", clientimage: "", clientbackground: "", birthday: Date(), school: "")))
...
//                    })
                ...
                Button{
                    ...
                    if self.mytitle != "" && self.mycontent != "" &&  pickeimage != []{
                        ...
                        pyqdata.UpLoadMyPyq(data:
                                            Carddata(title: mytitle, content: mycontent, locate:locate, publishtime:Date(),publishimageurl: [], pinlun: [],love:0,star:0,pyqobjectid : "",client: Client(username: "", clientname: "", introduction: "", sex: "", locate: "", clientimage: "", clientbackground: "", birthday: Date(), school: ""))
        ...
        .confirmationDialog("", isPresented: $showImageEdit) {
            ...
            Button(role:.destructive){
                withAnimation {
                    mySaveobject.Saveobjects = saveobject(mysavedimage: [], mypyqmessage: Carddata(title: "", content: "", locate: "", publishtime: Date(), publishimageurl: [], pinlun: [], love: 0, star: 0, pyqobjectid: "", client:  Client(username: "", clientname: "", introduction: "", sex: "", locate: "", clientimage: "", clientbackground: "", birthday: Date(), school: "")))
                    mySaveobject.saveMyPyq()
                    presentationMode.wrappedValue.dismiss()
                }
            }label: {
...
struct PYQPublishView_Previews: PreviewProvider {
    static var previews: some View {
        PYQPublishView( images: [])
