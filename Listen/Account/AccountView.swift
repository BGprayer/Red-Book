    ...
    func GetMyPyq(){
        if mypyq.isEmpty{
            for i in pyqdata.allPyqData{
                if i.client.clientname == Myclientdata.MyClient.username{
                    self.mypyq.append(i)
                }
            }
        }
            ...
            VStack{
                VStack{
                    ...
                    VStack{
                        VStack{
                            ...
                            NavigationLink{
                                ...
                                if Myclientdata.MyClient.introduction == ""{
                                    HStack{
                                        Text("向大家介绍自己")
                            ...
                            HStack{
                                ...
                                NavigationLink{
                                    ...
                                    Text("\(Getold(date:Myclientdata.MyClient.birthday))岁")
                                        .foregroundColor(.white)
                                        .font(.footnote)
                                        .padding(.vertical,2)
                    ...
                    VStack{
                        ...
                        TabView(selection: $selcet){
                            ...
                            NotBookView(mypyq: mynotdata.starMyself,dragsize: $dragsize,scrollsize:$scrollsize,scrollsizeall: $scrollsizeall)
                                .tag(1)

                            NotBookView(mypyq: mynotdata.LoveMyself,dragsize: $dragsize,scrollsize:$scrollsize,scrollsizeall: $scrollsizeall)
                                .tag(2)
                        }
                        .padding(.top,0)
                ...
                .overlay(
                    VStack{
                        ...
                        .padding(.top,40)
                        .padding(.bottom,10)
                        .background(dragsize < 0 ? .black.opacity(0.6):.clear)
                        Spacer()
                    }
