...
struct ReduceView_Previews: PreviewProvider {
    static var previews: some View {
        ReduceView().environmentObject(Model())
    }
}
...
struct MusicPlay : View {
    ...
    var body: some View{
        VStack(spacing: 10){
            ...
            Image(uiImage: self.data.count == 0 ? UIImage(named: "IMG_6415")! : UIImage(data: self.data)!)
                .resizable()
                .frame(width: self.data.count == 0 ? 250 : nil, height: 350)
                .cornerRadius(15)
