    ...
    var body: some View {
        NavigationView{
            ...
            .navigationBarHidden(true)
                ...
                .foregroundColor(.black)
                .frame(width: showMeun ? UIScreen.main.bounds.width / 3:0, height: showMeun ? UIScreen.main.bounds.height / 20:0)
                .background(.white,in: RoundedRectangle(cornerRadius: 10))
                .scaleEffect(showMeun ? 1:0)
                .offset(x: showMeun ?  UIScreen.main.bounds.width / 2 - 100 :UIScreen.main.bounds.width / 2 - 90, y: showMeun ? -UIScreen.main.bounds.height / 3 - 30:-UIScreen.main.bounds.height / 3 - 70)
                .offset(x:10,y: -10)
